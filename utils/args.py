...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    """
    # dataset
    parser.add_argument('--dataset', default='kandinsky', type=str, choices=DATASET_NAMES,
                        help='Which dataset to perform experiments on.')
    # model settings
    parser.add_argument('--model', type=str, default="glancenet", help='Model name.', choices=get_all_models())
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument('--checkout', type=str, default='data/ckpt', help='location and path  TO  where to store ckpt.' )    
    # post-hoc evaluation
    ...
    parser.add_argument('--sup_version', type=str, default='fullsup', help='Version of the supervised model.', choices=['fullsup', 'nolabel','12sup','30sup','badsup'])
    parser.add_argument('--w_label', type=float, default=1.0, help='Weight of the label loss.')
